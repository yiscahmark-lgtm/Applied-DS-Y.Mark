...
Project Two - [COVID E-commerce Project](Project2.md)
...
Project Three - [Fresno Almond Yeild Project](Project3.md)


This project investigates the impact of winter climate conditions on Fresno County almond production by integrating multi-decade NOAA hourly temperature logs with USDA agricultural datasets. By processing and de-duplicating over 10 years of weather records, the pipeline isolates critical winter dormancy months (November through February) to calculate annual average winter temperatures and correlates them with Fresno almond bearing acreage to analyze climate resilience and crop yield trends.
